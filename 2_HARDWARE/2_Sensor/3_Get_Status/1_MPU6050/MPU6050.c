/**--------------------------------
 @author：online
 @function：use mpu6050 get status
 @source：  IIC:PB8/9
-----------------------------------*/
...
{	
	  unsigned long sensor_timestamp;
		...
		{    
			 ...
			 q2=quat[2] / q30;
			 q3=quat[3] / q30;
			 Yaw = atan2(2 * q1 * q2 + 2 * q0 * q3, -2 * q2*q2 - 2 * q3* q3 + 1)* 57.3;//滚转
			 Pitch = asin(-2 * q1 * q3 + 2 * q0* q2)* 57.3; 	//俯仰
			 Roll = atan2(2 * q2 * q3 + 2 * q0 * q1, -2 * q1 * q1 - 2 * q2* q2 + 1)* 57.3; // 偏航
		}
